...
import {startService} from './../../../../Components/Application/action.js';
...
export const StartStopButtonsPanel = connect(mapStateToProps,{startService})(StartStopButtonsPanelClass);